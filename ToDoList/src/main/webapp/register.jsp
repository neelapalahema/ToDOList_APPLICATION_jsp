...
<link rel="icon" href="images/std.jpg">
...
<div class="main">
    ...
    <div class="row">
    <div class="col1">
        <img class="img" src="images/reg.jpg" alt="">
    </div>
    <div class="col2">
        ...
        <form action="doregister.jsp" method="post">
            ...
            <div class="mb">
                <input required="required" class="form-control" type="tel" name="mobile" placeholder="Phone:">
            </div>
            <div class="mb">
